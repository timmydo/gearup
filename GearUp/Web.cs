namespace GearUp
{
	...
	{
		private static readonly Uri alphabetServiceUri = new Uri(@"fabric:/GearUp/Backend");
		...
		private ICommunicationListener CreateInputListener(StatelessServiceInitializationParameters args)
		{
			...
			string uriPrefix = String.Format("{0}://+:{1}/gearup/", inputEndpoint.Protocol, inputEndpoint.Port);
